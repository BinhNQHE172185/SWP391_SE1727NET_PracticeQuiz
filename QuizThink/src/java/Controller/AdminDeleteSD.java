 ...
 * @author kimdi
 */
@WebServlet(name = "AdminDeleteSD", urlPatterns = {"/AdminDeleteSD"})
public class AdminDeleteSD extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            String title = subjectDimensionDAO.getSubjectDimensionByID(subjectDimensionId).getTitle();

            if (subjectDimensionDAO.deleteSubjectDimension(subjectDimensionId)) {
                request.setAttribute("status", title + " deleted!");
            } else {
                request.setAttribute("status", "Deletion failed, please try again later");
            }
