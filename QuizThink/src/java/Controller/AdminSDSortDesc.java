 ...
 * @author QUYBINH
 */
@WebServlet(name = "AdminSDSortDesc", urlPatterns = {"/AdminSDSortDesc"})
public class AdminSDSortDesc extends HttpServlet {
 ...
 /* TODO output your page here. You may use following sample code. */
            ...
            if ((request.getParameter("parentId") != null) && (Integer.parseInt(request.getParameter("parentId")) != -1)) {//restive current parentId if possible
                ...
                SDlist = subjectDimensionDAO.getChildSubjectDimensionsDesc(parentId, (page - 1) * recordsPerPage, recordsPerPage);
            } else {
                ...
                SDlist = subjectDimensionDAO.getAllParentSubjectDimensionsDesc((page - 1) * recordsPerPage, recordsPerPage);
            }
