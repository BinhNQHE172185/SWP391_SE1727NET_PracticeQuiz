...
<html lang="en">
    ...
    <head>
        ...
        <%  Membership mem = (Membership) request.getAttribute("MemList");
                    ...
                    <div class="col-lg-12 m-b30">
                        <div class="widget-box">
                            ...
                            <div class="widget-inner">
                                <form class="edit-profile m-b30" action="EditMembership" method="POST">
                                    <div class="row">
                                        <input name="id" type="hidden" value="<%=mem.getMembershipID()%>">
                                        <div class="form-group col-6">
                                            <label class="col-form-label">Membership title</label>
                                            <div>
                                                <input class="form-control" type="text" value="<%=mem.getTitle()%>" name="title" required="">
                                            </div>
                                        </div>
                                        <div class="form-group col-6">
                                            <label class="col-form-label">Price</label>
                                            <div>
                                                <input class="form-control" type="text" value="<%=mem.getPrice()%>" name="price" required="">
                                            </div>
                                        </div>
                                        <div class="form-group col-6">
                                            <label class="col-form-label">Discount</label>
                                            <div>
                                                <input class="form-control" type="text" value="<%=mem.getDiscount()%>" name="discount" required="">
                                            </div>
                                        </div>
                                        <div class="form-group col-12">
                                            <label class="col-form-label">Membership description</label>
                                            <div>
                                                <textarea class="form-control" name="desc"><%= mem.getDescription() %></textarea>
                                            </div>
                                        </div>
