<%-- 
    Document   : ChangePassProfile
    Created on : Oct 21, 2023, 3:14:27 PM
    Author     : admin
--%>
                ...
                <ul class="ttr-header-navigation">
                    ...
                    <li>
                        <a href="#" class="ttr-material-button ttr-submenu-toggle"><span class="ttr-user-avatar"><img
                                    alt="" src="admin/assets/images/testimonials/pic3.jpg" width="32" height="32"></span></a>
                        <div class="ttr-header-submenu">
                            <ul>
                        ...
                        <form class="edit-profile" action="ChangePassword" method="post">
                            <div class="">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <input class="form-control" type="text" value="${password}" readonly="">
                                    </div>
                                </div>
                                <div class="form-group row">
